...
const competitions = [
  ...
  },
  {
    ...
    endsIn: '14 hours',
    status: 'live',
    annualProfitPotential: 520000,
    tags: ['50p Entry', 'Fast Draw', 'Quick Payout', 'Cash Alternative Available'],
    profitMargin: '40% House, 60% Prize Pool (Transparent)',
    expectedWinners: 1,
  },
  {
    ...
    endsIn: '6 hours',
    status: 'live',
    annualProfitPotential: 310000,
    tags: ['20p Entry', 'Micro Draw', 'Fast Payout', 'Cash Alternative Available'],
    profitMargin: '40% House, 60% Prize Pool (Transparent)',
    expectedWinners: 1,
  },
  {
